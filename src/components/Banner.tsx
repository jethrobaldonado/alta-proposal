        ...
        <div className="flex flex-col justify-center items-center bg-hero-image h-screen w-screen bg-cover text-white">
            <div className="flex flex-col justify-center items-center w-1/3">
                ...
                <div className="text-center font-sans mb-3">
                    Discover unparalleled luxury and comfort at <b>Alta D’ Tagaytay</b>, where every moment is crafted to make your stay truly memorable.
                </div>
                <div>
                    <button className="flex justify-center items-center bg-opacity-5 hover:bg-opacity-45 bg-white border-white border border-solid py-2 px-4 rounded-full shadow">
